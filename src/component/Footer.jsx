...
const Footer = () => {
  ...
  <>
   <style>{`
            ...
            <footer className=" rounded-md flex flex-col bg-linear-to-r from-zinc-950 to-emerald-300  items-center justify-around w-full py-16 text-sm text-white">
                 <h2 className='text-3xl' >Mustufa Memon </h2> 
                 <br/>
                ...
                <div className="flex items-center gap-4 mt-8 text-amber-50">
                ...
                <p className="mt-8 text-center">Copyright © 2025 <a href="/">TechLogo</a>. All rights reservered.</p>
            </footer>
  </> 
  )
}
